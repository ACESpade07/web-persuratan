...
<div class="max-w-2xl" style="padding: 1.5rem 0;">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <p class="text-xs font-medium text-gray-400 uppercase tracking-widest mb-1">Surat Masuk</p>
        <h1 class="text-xl font-medium text-gray-900">Tambah Surat Masuk</h1>
    </div>
    ...
    <form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white border border-gray-100 rounded-xl overflow-hidden">
            ...
            <div class="flex items-center gap-2 px-6 py-4 border-b border-gray-100">
                ...
                <span class="text-sm font-medium text-gray-500">Informasi Surat</span>
            </div>
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        {{-- Preview format --}}
                        <p class="text-[11px] text-gray-300 mt-1 pl-1">
                            Format: <span class="font-mono">001/SM/V/2025</span>
                            &nbsp;·&nbsp; urut/jenis/bulan-romawi/tahun
                        </p>
